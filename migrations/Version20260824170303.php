 ...
 */
final class Version20260824170303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vegetable_season (vegetable_id INT NOT NULL, season_id INT NOT NULL, INDEX IDX_3EDABE613D33F4D6 (vegetable_id), INDEX IDX_3EDABE614EC001D1 (season_id), PRIMARY KEY (vegetable_id, season_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE disease_vegetable (disease_id INT NOT NULL, vegetable_id INT NOT NULL, INDEX IDX_E6DB648D3D33F4D6 (vegetable_id), INDEX IDX_E6DB648DD8355341 (disease_id), PRIMARY KEY (disease_id, vegetable_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE season_vegetable (season_id INT NOT NULL, vegetable_id INT NOT NULL, INDEX IDX_50AADA184EC001D1 (season_id), INDEX IDX_50AADA183D33F4D6 (vegetable_id), PRIMARY KEY (season_id, vegetable_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
